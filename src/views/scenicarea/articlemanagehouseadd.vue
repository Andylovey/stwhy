        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="14">
            <el-form-item label="标题" prop="ha_title">
                <el-input v-model="AddForm.ha_title"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
      ...
      AddSave(formName) {
            this.$refs[formName].validate((valid) => {
                if(valid) {
                    ...
                    formdata.append('ha_title',this.AddForm.ha_title);
                    formdata.append('ha_building',this.$route.params.bid);
                    formdata.append('ha_content',this.AddForm.ha_content);
                    this.$http.post(`${api.dev}/p/main/houseArticle/save`,formdata,{emulateJSON:true}).then(res => {
