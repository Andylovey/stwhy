        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="14">
            <el-form-item label="标题" prop="va_title">
                <el-input v-model="AddForm.va_title"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
      ...
      AddSave(formName) {
            this.$refs[formName].validate((valid) => {
                if(valid) {
                    ...
                    formdata.append('va_title',this.AddForm.va_title);
                    formdata.append('va_building',this.$route.params.bid);
                    formdata.append('va_content',this.AddForm.va_content);
                    this.$http.post(`${api.dev}/p/main/venueArticle/save`,formdata,{emulateJSON:true}).then(res => {
