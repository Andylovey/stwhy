<template>
  <div>
    <router-link :to="'/scenicarea/venue/venueadd/add'">
    ...
    <el-table
        ...
        <template slot-scope="scope">
          <img  :src="scope.row.b_photo" height="100px">
        </template>
        </el-table-column> -->
        <el-table-column
        prop="b_addr"
        ...
        <template slot-scope="scope">
            ...
            <router-link :to="'/scenicarea/venue/article/articlemanage/'+ permissionArticleID + '/' + scope.row.b_id + '/' + scope.row.b_name">
                <el-button v-if="permissionArticle" type="text" size="small">文章管理</el-button>
            </router-link>
            <router-link :to="'/scenicarea/venue/venuedetail/'+scope.row.b_id">
                <el-button v-if="permissionDetail" type="text" size="small" style="margin-left:10px">查看</el-button>
            </router-link>
            <router-link :to="'/scenicarea/venue/venueedit/'+scope.row.b_id">
    ...
    <el-dialog 
      ...
      <el-form ref="DetailForm" :model="DetailForm" label-width="80px">
          ...
          <el-form-item label="邮政编码">
            <el-input v-model="DetailForm.bv_code" disabled></el-input>
          </el-form-item>
          ...
          <el-form-item label="地址">
            <el-input v-model="DetailForm.bv_addr" disabled></el-input>
          </el-form-item>
          <el-form-item label="名称">
            <el-input v-model="DetailForm.b_name" disabled></el-input>
          </el-form-item>
          <el-form-item label="联系方式">
            <el-input v-model="DetailForm.bv_tel" disabled></el-input>
          </el-form-item>
          <el-form-item label="地区ID">
            <el-input v-model="DetailForm.b_area" disabled></el-input>
          </el-form-item>
          <el-form-item label="网站地址">
            <el-input v-model="DetailForm.bv_url" disabled></el-input>
          </el-form-item>
      </el-form>
    </el-dialog>
    <!-- 编辑的模态框 -->
    <el-dialog 
      ...
      <el-form ref="EditForm" :model="EditForm" label-width="80px" :rules="EditRules">
          ...
          <el-form-item label="邮政编码" prop="bv_code">
            <el-input v-model="EditForm.bv_code"></el-input>
          </el-form-item>
          ...
          <el-form-item label="地址" prop="bv_addr">
            <el-input v-model="EditForm.bv_addr"></el-input>
          </el-form-item>
          <el-form-item label="名称" prop="b_name">
            <el-input v-model="EditForm.b_name"></el-input>
          </el-form-item>
          <el-form-item label="联系方式" prop="bv_tel">
            <el-input v-model="EditForm.bv_tel"></el-input>
          </el-form-item>
          <el-form-item label="地区ID" prop="b_area">
            <el-input v-model="EditForm.b_area"></el-input>
          </el-form-item>
          <el-form-item label="网站地址" prop="bv_url">
            <el-input v-model="EditForm.bv_url"></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <el-dialog 
      ...
      <el-form ref="AddForm" :model="AddForm" label-width="80px" :rules="AddRules">
          ...
          <el-form-item label="邮政编码" prop="bv_code">
            <el-input v-model="AddForm.bv_code"></el-input>
          </el-form-item>
          <el-form-item label="负责人" prop="b_director">
          ...
          <el-form-item label="图片" prop="b_photo">
            <!-- <el-input v-model="AddForm.b_photo" disabled></el-input> -->
          ...
          <el-form-item label="地址" prop="bv_addr">
            <el-input v-model="AddForm.bv_addr"></el-input>
          </el-form-item>
          <el-form-item label="名称" prop="b_name">
            <el-input v-model="AddForm.b_name"></el-input>
          </el-form-item>
          <el-form-item label="联系方式" prop="bv_tel">
            <el-input v-model="AddForm.bv_tel"></el-input>
          </el-form-item>
          <el-form-item label="地区ID" prop="b_area">
            <el-input v-model="AddForm.b_area"></el-input>
          </el-form-item>
          <el-form-item label="网站地址" prop="bv_url">
            <el-input v-model="AddForm.bv_url"></el-input>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  data() {
      return {
          ...
          EditRules : {
                ...
                b_id : [{required: true,message : '请输入序号', trigger: 'blur'}],
                b_lon : [{required: true,message : '请输入经度', trigger: 'blur'}],
                bv_code : [{required: true,message : '请输入邮政编码', trigger: 'blur'}],
                ...
                bv_addr : [{required: true,message : '请输入地址', trigger: 'change'}],
                b_name : [{required: true,message : '请输入名称', trigger: 'blur'}],
                bv_tel : [{required: true,message : '请输入联系方式', trigger: 'blur'}],
                b_area : [{required: true,message : '请输入地区名称', trigger: 'blur'}],
                bv_url : [{required: true,message : '请输入网站地址', trigger: 'blur'}],
          },
          ...
          AddRules : {
            ...
            bv_tel : [{required: true,message : '请输入联系方式', trigger: 'blur'}],
            b_area : [{required: true,message : '请输入地区名称', trigger: 'blur'}],
            bv_url : [{required: true,message : '请输入官方网址', trigger: 'blur'}],
          },
  ...
  methods : {
    ...
    getLimit() {
      ...
      getInfo(){
          this.$http.get(`${api.dev}/p/main/venue/show`,{params : {access_token : getToken() ,start : this.start,limit : this.limit}}).then(res => {
                if(res.body.code == 200) {
      ...
      handleDetail(row) {
          ...
          this.$http.get(`${api.dev}/p/main/venue/select`,{params: {access_token: getToken() , b_id : row.b_id}}).then(res => {
              if(res.body.code == 200) {
                  // 关闭加载器
                  loading.close();
                  ...
                  this.DetailForm.b_photo = res.body.content.venue.b_photo;
                  this.DetailForm.b_name = res.body.content.venue.b_name;
                  this.DetailForm.b_area = res.body.content.venue.b_area;
                  this.DetailForm.bv_addr = res.body.content.venueDetail.bv_addr;
                  this.DetailForm.bv_tel = res.body.content.venueDetail.bv_tel;
                  this.DetailForm.bv_code = res.body.content.venueDetail.bv_code;
                  this.DetailForm.bv_url = res.body.content.venueDetail.bv_url;
              }else if (res.body.code == 500) {
                    this.$message({
                        message: res.body.msg,
                        type: 'error'
      ...
      handleEdit(row) {
            ...
            this.$http.get(`${api.dev}/p/main/venue/select`,{params: {access_token : getToken() , b_id : row.b_id}}).then(res => {
                if(res.body.code == 200) {
                    ...
                    this.EditForm.b_code = res.body.content.venue.b_code;
                    this.EditForm.b_lat = res.body.content.venue.b_lat;
                    this.EditForm.b_id = res.body.content.venue.b_id;
                    this.EditForm.b_lon = res.body.content.venue.b_lon;
                    this.EditForm.b_director = res.body.content.venue.b_director;
                    this.EditForm.b_desc = res.body.content.venue.b_desc;
                    this.EditForm.b_photo = res.body.content.venue.b_photo;
                    this.EditForm.b_name = res.body.content.venue.b_name;
                    this.EditForm.b_area = res.body.content.venue.b_area;
                    this.EditForm.bv_addr = res.body.content.venueDetail.bv_addr;
                    this.EditForm.bv_tel = res.body.content.venueDetail.bv_tel;
                    this.EditForm.bv_code = res.body.content.venueDetail.bv_code;
                    this.EditForm.bv_url = res.body.content.venueDetail.bv_url;

                    this.EditFileList = [{url: res.body.content.venue.b_photo}];
                }
            })
      },
      handleDelete(row) {
          this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
            ...
            type: 'warning'
              ...
              this.loading = true;
              this.$http.post(`${api.dev}/p/main/venue/delete`,{access_token: getToken(), b_id : row.b_id},{emulateJSON:true}).then(res => {
                  if(res.body.code == 200) {
                    this.$message({
                        message: '删除成功',
                        type: 'success'
      ...
      submitEditForm(formName) {
          this.$refs[formName].validate((valid) => {
              if(valid) {
                    ...
                    formdata.append('bv_addr',this.EditForm.bv_addr);
                    formdata.append('bv_tel',this.EditForm.bv_tel);
                    formdata.append('bv_code',this.EditForm.bv_code);
                    formdata.append('bv_url',this.EditForm.bv_url);
                    this.$http.post(`${api.dev}/p/main/venue/update`,formdata,{emulateJSON:true}).then(res => {
                        if(res.body.code == 200) {
                            loading.close();
      ...
      submitAddForm(formName) {
          this.$refs[formName].validate((valid) => {
              if(valid) {
                    ...
                    formdata.append('bv_addr',this.AddForm.bv_addr);
                    formdata.append('bv_tel',this.AddForm.bv_tel);
                    formdata.append('bv_code',this.AddForm.bv_code);
                    formdata.append('bv_url',this.AddForm.bv_url);
