		...
		<el-dialog 
			...
			<el-form ref="AddForm" :model="AddForm" label-width="140px" :rules="AddRules" style="width:100%;">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="所属部门" prop="admin_dpm">
							<el-select class="padding-right-12" v-model="AddForm.admin_dpm" name="add_admin_dpm" auto-complete="off" placeholder="请选择所属部门" style="width:200px" clearable @change="getDuty(AddForm)">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="密码" prop="password">
							<el-input v-model="AddForm.password" name="add_password" auto-complete="off" type="password" placeholder="(6位以上/不能纯数字/字母/符号)" style="width: 260px"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="职务" prop="admin_duty">
							<el-select class="padding-right-12" v-model="AddForm.admin_duty" name="admin_duty" auto-complete="off" placeholder="请选择职务" style="width:200px" clearable >
				...
				<el-form-item label="确认密码" prop="rePassword">
					<el-input v-model="AddForm.rePassword" name="add_rePassword" auto-complete="off" type="password" placeholder="请再次输入密码" style="width: 260px"></el-input>
				</el-form-item>
		...
		<el-dialog 
			...
			<el-form ref="EditForm" :model="EditForm" label-width="140px" :rules="EditRules" style="width:100%;">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="所属部门" prop="admin_dpm">
							<el-select class="padding-right-12" v-model="EditForm.admin_dpm" name="edit_admin_dpm" auto-complete="off" placeholder="请选择所属部门" style="width:200px" clearable @change="getDuty(EditForm)">
								<el-option v-for="item in departmentList" :label="item.name" :value="item.id" :key="item.id"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="职务" prop="admin_duty">
							<el-select class="padding-right-12" v-model="EditForm.admin_duty" name="edit_admin_duty" auto-complete="off" placeholder="请选择职务" style="width:200px" clearable >
								<el-option v-for="item in dutyList" :label="item.name" :value="item.id" :key="item.id"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
		...
		<el-dialog 
			...
			<el-form ref="RePswForm" :model="RePswForm" label-width="80px" :rules="RePswRules" style="width:100%;">
				...
				<el-form-item label="新密码" prop="password">
					<el-input v-model="RePswForm.password" type="password" placeholder="请输入新密码" name="repsw_password" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="确认密码" prop="rePassword">
					<el-input v-model="RePswForm.rePassword" type="password" placeholder="请再次输入新密码" name="repsw_rePassword" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item class="text-align-right">
