<template>
  <div>
    <el-form ref="DetaiForm" :model="DetaiForm" label-width="80px" style="margin-top:10px;margin-bottom:60px;">
        <el-row type="flex" class="row-bg">
          <el-col :span="14">
            <el-form-item label="标题" prop="va_title">
                <el-input v-model="DetaiForm.va_title" readonly></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
      ...
      getInfo() {
          this.$http.get(`${api.dev}/p/main/venueArticle/select`,{params:{access_token:getToken(),va_id:this.$route.params.vaid}}).then(res => {
              if(res.body.code == 200) {
                    this.DetaiForm = res.body.content;
