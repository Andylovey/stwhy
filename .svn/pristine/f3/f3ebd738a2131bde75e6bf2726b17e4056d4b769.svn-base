<template>
  <div>
    <el-tabs tab-position="left" @tab-click="handleClickTopic" type="border-card" style="height:100%;" class="tabs-topic">
    ...
    <el-dialog
      ...
      width="500px" 
      :close-on-click-modal="false"
      class="setFieldsMySelf">
      <el-form style="width:100%;border:1px solid #ccc;padding:5px;">
        <el-row type="flex" class="row-bg" style="height:300px;overflow-y:scroll;padding-bottom:50px;">
          <el-col :span="12">
            <h3 style="margin:-50px 0 0 -5px;line-height:40px;background:#f2f2f2;text-align:center;width:222px;position:fixed;z-index:999;">字段名称</h3>
            <el-form-item>
                <el-checkbox-group v-for="item in getFieldArr" :key="item.f_id" v-model="checkList" style="border-bottom:1px dashed #ccc;">
                  <el-checkbox :label="item.f_id">{{item.f_name}}</el-checkbox>
                </el-checkbox-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <h3 style="margin:-50px 0 0 0;line-height:40px;background:#f2f2f2;text-align:center;width:227px;position:fixed;z-index:999;">是否必选</h3>
            <el-form-item>
              <el-checkbox-group v-for="item in getFieldArr" :key="item.f_id" v-model="mustCheckList" style="border-bottom:1px dashed #ccc;">
...
<style>
.el-dialog__wrapper.setFieldsMySelf .el-dialog__header {
  margin-bottom: 20px
}
</style>
